...
public class preOrder {
    ...
    public static void preOrderTransversal(Tree<Integer> root){
        if(root==null){
            return;
        }
        ...
        for(int i=0;i<root.children.size();i++){
            preOrderTransversal(root.children.get(i));
        }
    }
    ...
    public static void main(String[] args) throws EmptyQueue {
        ...
        printTree(root);
        System.out.println("The preorder transversal of the tree is:");
