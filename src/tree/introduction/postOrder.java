...
public class postOrder {
    ...
    public static void postOrderTransversal(Tree<Integer> root){
        if(root==null){
            return;
        }

        for(int i=0;i<root.children.size();i++){
            postOrderTransversal(root.children.get(i));
        }
    ...
    public static void main(String[] args) throws EmptyQueue {
       ...
       printTree(root);
       System.out.println("The post order transversal of the tree is:");
